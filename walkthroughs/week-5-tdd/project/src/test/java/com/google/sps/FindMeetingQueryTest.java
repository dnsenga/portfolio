...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredOptionalAttendeeNotFree() {
    // Have two mandatory attendees with free time and an optional attendee with no free time
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void everyAttendeeIsConsideredOptionalAttendeeFree() {
    // Have two mandatory and an optional attendee with common free time
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void justEnoughRoomOptionalAttendeeNotFree() {
    // Have a mandatory and an optional attendee without common free time
    //
    // Events  : |--A--|     |----A----|
    //                 |-B-|
    // Day     : |---------------------|
  ...
  @Test
  public void optionalAttendeeMultipleGaps() {
    // Have a mandatory and a optional attendee with common free time
    //
    // Events  :         |--A--|     |--A--|
    //           |--B--|   |-B-|  |--B--|
    // Day     : |--------------------------------|
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0930AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 3", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0815AM, false),
            Arrays.asList(PERSON_B)),
        new Event("Event 4", TimeRange.fromStartDuration(TIME_0845AM, DURATION_15_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 5", TimeRange.fromStartDuration(TIME_0915AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)));

    MeetingRequest request =
        new MeetingRequest(Arrays.asList(PERSON_A), DURATION_15_MINUTES);
    request.addOptionalAttendee(PERSON_B);

    Collection<TimeRange> actual = query.query(events, request);
    Collection<TimeRange> expected =
        Arrays.asList(TimeRange.fromStartEnd(TIME_0815AM, TIME_0830AM, false),
            TimeRange.fromStartEnd(TIME_0900AM, TIME_0915AM, false),
            TimeRange.fromStartEnd(TIME_1000AM, TimeRange.END_OF_DAY, true));
  ...
  public void optionalAttendeeNoGaps() {
    // Have two optional attendess with no free time
    //
    // Events  : |--------------A--------------|     
    //         : |--------------B--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void justOneOptionalAttendeeNoGaps() {
    // Have two optional attendess with no free time
    //
    // Events  : |--------------A--------------|
    // Day     : |-----------------------------|
